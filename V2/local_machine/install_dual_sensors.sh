#!/bin/bash
# Installation script for Dual AS608 Fingerprint Sensor System (3.3V)

echo "=========================================="
echo "Dual AS608 Fingerprint Sensor Installation (3.3V)"
echo "=========================================="
...
echo "3. Run the system: python3 dual_fingerprint_simple_client.py"
echo ""

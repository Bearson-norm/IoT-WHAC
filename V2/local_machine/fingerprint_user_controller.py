...
class FingerprintUserController:
    ...
    def init_database(self):
        """Initialize enhanced SQLite database with user management features"""
        try:
            ...
            # Enhanced verification log table
            cursor.execute('''
            ...
            conn.commit()
            conn.close()
            logger.info(f"✓ Enhanced database initialized: {self.db_file}")
